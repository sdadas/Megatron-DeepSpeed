...
def main():
    ...
    parser.add_argument(
        ...
        default="",
        type=str,
        help="GPT-2 architecture type / size.",
    )
    ...
    if args.config_file == "":
        ...
        selected_params = gpt_arch_params[args.gpt_arch]
        config = GPT2Config(
            vocab_size=51200,
            n_positions=selected_params["n_positions"],
            n_embd=selected_params["n_embd"],
            n_layer=selected_params["n_layer"],
            n_head=selected_params["n_head"],
            n_inner=selected_params["n_inner"],
    ...
    if ds_args is not None:
        ...
        if tokenizer_type == "GPT2BPETokenizer" or tokenizer_type == "HuggingFaceTokenizer":
